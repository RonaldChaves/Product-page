export const dataBakery = [
    {
        'id': '1',
        'type': 'bolos', // usado na barra de pesquisa
        'text': ' ',
        'stock': 'Disponível',
    ...
    {
        'id': '2',
        'type': 'docinhos', // usado na barra de pesquisa
        'text': 'Mas também temos...',
        'stock': 'Indisponível',
    ...
    {
        'id': '3',
        'type': 'cupcake', // usado na barra de pesquisa
        'text': 'A Moda da casa... 👇😁',
        'stock': 'Disponível',
        'title': 'CUPCAKE',
    ...
    {
        'id': '4',
        'type': 'bolo-aniversario', // usado na barra de pesquisa
        'text': 'E para alegrar seu dia 🎁✨ ESPECIAL ✨🎁',
        'stock': 'Disponível',
    ...
    {
        'id': '5',
        'type': 'brownies', // usado na barra de pesquisa
        'text': 'Hmmm chocolateee 🍫',
        'stock': 'Disponível',
        'title': 'BROWNIES',
    ...
    {
        'id': '6',
        'type': 'donuts', // usado na barra de pesquisa
        'text': 'Algo mais rápido e simples??',
        'stock': 'Indisponivel',
        'title': 'ROSCAS (DONUTS)',
